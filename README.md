...
- I built the Android APK for an Oreo target. As your target may be different, please review and adjust the \*SdkVersion setting in the app's build.gradle file accordingly.
